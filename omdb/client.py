...
class OmdbMovie:
  """A simple class to represent movie data coming 
  back from OMDb and transform to Python types."""
...
class OmdbClient:
  ...
  def make_request(self, params):
    """Make a GET request to the API, automatically adding the `api_key`
    to parameters."""
  ...
  def search(self, search):
    """Search for movies by title. This is a generator so all results
